...
function LanguageChange(lang)
{
    ...
    else if (lang === "chinese")
    {
        ...
        document.getElementById("wrapper").style.backgroundImage = "url('Images/photo_bg_ch.png')";
    }
}
...
function SelectFrame(num)
{
    ...
    {
        document.getElementById("frame").src = "Images/Frames/frame0"+num+".png";
        frameImagePath = GetCurrentFolderPath() + "Images/Frames/frame0"+num+".png";
...
function SendEmail()
{
    ...
    var subject = "Welcome to Los Angeles International Airport.";
    ...
    var mail_addr_sender = "selfie_lax@getrobotsolutions.com";
    var pswd = "R0b0ts60";
    var port = 587;
    var ssl = "false";
